...
python src/protector.py build/program.bytecode build/protected_program.hpkg --license-id STUDENT-USB-KEY-001
python src/runtime.py build/protected_program.hpkg --key-path demo_usb_key
